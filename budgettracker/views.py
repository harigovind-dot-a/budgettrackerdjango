...
from .serializers import BudgetSerializer, TransactionSerializer, CategorySerializer, RegisterSerializer
...
# Added RegisterView to validate user form in Angular
